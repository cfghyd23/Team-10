  ...
  return (
    <header id="header">
      ...
      <Carousel infiniteLoop autoPlay interval={2000}>
        <div>
          <img src="img/assets/cropped-BWI_Icon_Pink-1-150x150.png" alt="Image 1" />
        </div>
        <div>
          <img src="img/assets/cropped-BWI_Icon_Pink-1-150x150.png" alt="Image 2" />
        </div>
        <div>
        ...
        <div>
          <img src="img/assets/cropped-BWI_Icon_Pink-1-150x150.png" alt="Image 3" />
        </div>
        <div>
          <img src="img/assets/NGOs.png" alt="Image 1" />
        </div>
