  ...
  return (
    <header id="header">
      ...
      >
        ...
        <div>
          <div className="carousel-item">
            <img src="img/assets/5.png" alt="Image 3" style={{ maxWidth: '50%' }} />
            <img src="img/assets/download.png" alt="Image 4" style={{ maxWidth: '50%' }} />
          </div>
        </div>
        <div>
          <div className="carousel-item">
            <img src="img/assets/images.png" alt="Image 3" style={{ maxWidth: '50%' }} />
            <img src="img/assets/2.png" alt="Image 4" style={{ maxWidth: '50%' }} />
          </div>
        </div>
      </Carousel>
    </header>
